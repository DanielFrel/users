...
export const Users = ({ items, isLoading, searchValue, onChangeSearchValue, invites, onCklickInvite, onCklickSendInvites}) => {
  return (
    ...
    <>
      ...
      {invites.length > 0 && (
      <button onClick={onCklickSendInvites} className="send-invite-btn">Отправить приглашение</button>)}
    </>
  );
};
