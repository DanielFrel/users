...
export const User = ({id, email, first_name, last_name, avatar, onCklickInvite, isInvited}) => (
  <li>
    <div>
    ...
    <p onClick={() => onCklickInvite(id)} className="action plus" alt="Action">{isInvited ? '-' : '+'}</p>
    {/* <img className="action" src="./image1.jpeg" alt="Action" /> */}
    {/* <img className="action" src="./plus.png" alt="Action" /> */}
  </li>
);
